...
class Task(LastSeenMixin, ORMBase):
    ...
    result = relationship("ramsis.worker.utils.orm.Reservoir", uselist=False,
                          cascade="all, delete, delete-orphan",
                          single_parent=True)

    model = relationship("ramsis.worker.utils.orm.Model",
...
class Model(ORMBase):
    ...
    tasks = relationship("ramsis.worker.utils.orm.Task",
