...
implementations. :cls:`ramsis.sfm.worker.utils.AbstractWorkerResource``extends the
resource API e.g. by means of handling an instance of a concrete
;cls:`ramsis.sfm.worker.utils.Task` object.

Hence, to implement a concrete worker follow this recipe:

    1. Provide a concrete implementation of :cls:`ramsis.sfm.worker.utils.Task`.
    2. Provide a concrete implmentation of
    :cls:`ramsis.sfm.worker.utils.AbstractWorkerResource`.
...
`ramsis.sfm.worker.SaSS` package.
"""
